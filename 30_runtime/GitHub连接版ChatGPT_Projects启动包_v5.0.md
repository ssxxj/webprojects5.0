...
若需要判断当前 GitHub 连接版 Project 是否真的达到了“会做事”的程度，建议使用：

- `30_runtime/GitHub连接版Projects验收题单_v1.0.md`
