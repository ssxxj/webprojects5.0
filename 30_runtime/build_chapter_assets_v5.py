...
def generate_lesson_assets(lesson_payload: dict[str, Any], lesson_input_path: Path, chapter_dir: Path) -> dict[str, str]:
    ...
    return {"lesson_script": str(output_path), "lesson_manifest": str(manifest_path)}
...
def build_manifest(
    ...
    return {
        ...
        "lesson_input_file": str(lesson_input_path),
        "assignment_outputs": assignment_files,
        "lesson_outputs": lesson_files,
    }
