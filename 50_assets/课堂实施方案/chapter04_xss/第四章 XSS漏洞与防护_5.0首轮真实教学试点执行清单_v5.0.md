...
- [第四章 XSS漏洞与防护_教师版讲义_v5.0.md](<../../章节讲义/chapter04_xss/第四章 XSS漏洞与防护_教师版讲义_v5.0.md>)
- [第四章 XSS漏洞与防护_学生预习版讲义_v5.0.md](<../../章节讲义/chapter04_xss/第四章 XSS漏洞与防护_学生预习版讲义_v5.0.md>)

### 4.2 课堂执行

- [第四章 XSS漏洞与防护_课堂实施方案_v5.0.md](<第四章 XSS漏洞与防护_课堂实施方案_v5.0.md>)
- [lesson_script_input_v5.yaml](lesson_script_input_v5.yaml)

### 4.3 作业与评分

- [第四章 XSS漏洞与防护_教师端作业包_v5.0.md](<../../assignment_packs/chapter04_xss/第四章 XSS漏洞与防护_教师端作业包_v5.0.md>)
- [chapter04_xss.json](../../../40_evaluation/runtime/chapter_profiles/chapter04_xss.json)
