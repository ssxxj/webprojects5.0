...
1. [章节讲义迁移策略_v5.0.md](/Users/shen/教学/web应用安全与防护/web应用安全与防护projects5.0/50_assets/章节讲义迁移策略_v5.0.md)
2. [assignment_packs/README_v5.0.md](/Users/shen/教学/web应用安全与防护/web应用安全与防护projects5.0/50_assets/assignment_packs/README_v5.0.md)
3. [讲义层治理策略_v5.0.md](/Users/shen/教学/web应用安全与防护/web应用安全与防护projects5.0/50_assets/章节讲义/讲义层治理策略_v5.0.md)
